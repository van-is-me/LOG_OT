...
public record UpdateEndtimeForWorkMorningRequest : IRequest
{
    public DateTime DayTime { get; set; }
    public ShiftEnum Shift { get; set; }

}
public class UpdateEndtimeForWorkMorningRequestHandler : IRequestHandler<UpdateEndtimeForWorkMorningRequest>
{
    private readonly IApplicationDbContext _context;

    public UpdateEndtimeForWorkMorningRequestHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<Unit> Handle(UpdateEndtimeForWorkMorningRequest request, CancellationToken cancellationToken)
    {
