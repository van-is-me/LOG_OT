...
{
    /// <inheritdoc />
    public partial class updateAttendant2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropPrimaryKey(
                name: "PK_RegionalMinimumWage",
                table: "RegionalMinimumWage");

            migrationBuilder.DropPrimaryKey(
                name: "PK_DefaultConfig",
                table: "DefaultConfig");

            migrationBuilder.RenameTable(
                name: "RegionalMinimumWage",
                newName: "RegionalMinimumWages");

            migrationBuilder.RenameTable(
                name: "DefaultConfig",
                newName: "DefaultConfigs");

            migrationBuilder.AddPrimaryKey(
                name: "PK_RegionalMinimumWages",
                table: "RegionalMinimumWages",
                column: "Id");

            migrationBuilder.AddPrimaryKey(
                name: "PK_DefaultConfigs",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameWifi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WifiIpv4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfigWifis", x => x.Id);
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameTable(
                name: "RegionalMinimumWages",
                newName: "RegionalMinimumWage");
