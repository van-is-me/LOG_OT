    ...
    public partial class updateShift2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ShiftConfigs",
                columns: new[] { "Id", "Created", "CreatedBy", "EndTime", "IsDeleted", "LastModified", "LastModifiedBy", "ShiftEnum", "StartTime" },
                values: new object[,]
                {
                    { new Guid("25482772-d7ac-473b-9548-9ef38dfb1be1"), new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test", new DateTime(2023, 6, 22, 17, 30, 0, 0, DateTimeKind.Unspecified), false, new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test", 1, new DateTime(2023, 6, 22, 13, 30, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("8caed193-c40e-448b-bdab-cd7cd4f24844"), new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test", new DateTime(2023, 6, 22, 12, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test", 0, new DateTime(2023, 6, 22, 8, 0, 0, 0, DateTimeKind.Unspecified) }
                });
        }
