        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MucchiuthueFrom = table.Column<double>(name: "Muc_chiu_thue_From", type: "float", nullable: false),
                    MucchiuthueTo = table.Column<double>(name: "Muc_chiu_thue_To", type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailTaxs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailTaxs_PaySlip_PayslipId",
